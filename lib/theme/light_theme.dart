...
class LightTheme {
  ...
  static ColorScheme colorScheme = ColorScheme(
    ...
    primary: Color(0xFF690679),
    onPrimary: Color(0xFFFFFFFF),
    secondary: Color(0xFF9C4DA6),
    onSecondary: Color(0xFFFFFFFF),
    tertiary: Color(0xFFD6A3DE),
    onTertiary: Color(0xFF3A003F),
    surface: Color(0xFFF2EDE3),
    onSurface: Color(0xFF1F1A1D),
    surfaceContainerHigh: Color(0xFFE6D9E8),
    onSurfaceVariant: Color(0xFF4A3A4D),
    error: Color(0xFFB3261E),
    onError: Color(0xFFFFFFFF),
    outline: Color(0xFF8F7A92),
    shadow: Color(0xFF000000),
    inverseSurface: Color(0xFF332B30),
    onInverseSurface: Color(0xFFF6EEF3),
    inversePrimary: Color(0xFFE6B7EF),
  );
